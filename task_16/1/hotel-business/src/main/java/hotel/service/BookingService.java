...
public class BookingService implements IBookingService {
    ...
    public Optional<Bookings> addServiceToBooking(Integer bookingId, List<Integer> serviceId) throws SQLException {
        bookingsRepository.addBookingServices(bookingId, serviceId);
