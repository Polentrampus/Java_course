...
public class BookingDAO implements BaseDAO<Bookings> {
    ...
    public boolean save(Bookings booking) {
        ...
        try {
            ...
            try (PreparedStatement stmt = conn.prepareStatement(SAVE_SQL, Statement.RETURN_GENERATED_KEYS)) {
    ...
    private Bookings buildBooking(ResultSet rs) throws SQLException {
        ...
        client.setDate_of_birth(clientBirth != null ? clientBirth.toLocalDate() : null);
