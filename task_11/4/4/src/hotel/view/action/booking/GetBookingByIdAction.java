...
public class GetBookingByIdAction extends BaseAction {
    ...
    public GetBookingByIdAction(BookingService bookingService, Scanner scanner,
    ...
    private void printBookingDetails(Bookings booking) throws SQLException {
        ...
        System.out.println("Дата рождения: " +  clientService.findById(booking.getClient()).get().getDate_of_birth());
