...
public class AdminController {
    ...
    public AdminController(ClientService clientService, ServicesService servicesService,
                           List<Employee> employees, EmployeeService employeeService,
                           HotelConfiguration hotelConfiguration, ServiceFactory serviceFactory, BookingService bookingService) {
