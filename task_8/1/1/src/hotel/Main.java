...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            adminController = initializeHotelWithSampleData();
        }
    ...
    private static AdminController initializeHotelWithSampleData() throws Exception {
        Hotel hotel = Hotel.getInstance();
        ...
        EmployeeService employeeService = new EmployeeService(admin);
        BookingService bookingService = new BookingService();

        AdminController adminController = new AdminController(clientService, servicesService,
                employees, employeeService, config, serviceFactory, bookingService);
