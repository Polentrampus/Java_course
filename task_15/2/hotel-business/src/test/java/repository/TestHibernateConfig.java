package repository;
import hotel.database.HibernateUtil;
...
public class TestHibernateConfig {
    ...
    @Bean
    @Primary
    public HibernateUtil testHibernateUtil(SessionFactory sessionFactory) {
    ...
    @Bean
    @Primary
    public TransactionManager testTransactionManager(SessionFactory sessionFactory) {
        return new TransactionManager(sessionFactory);
    }
}